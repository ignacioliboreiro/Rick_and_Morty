...
const About = () => {
    return (
        <div className="card">
            <div className="img"><img className='fotoAbout' src="../../public/img/fotoAbout.jpeg" alt="" /></div>
            <span>About Me</span>
            <p className="info">Hola mi nombre es Ignacio Liboreiro estoy estudiando desarollo Web Full Stack en el bootcamp de Henry </p>
            <div className="share">
                <a  href="https://github.com/ignacioliboreiro"  className="social-link1">
                ...
                <a  href='https://www.linkedin.com/in/ignacio-castor-liboreiro-28b5631b0/' className="social-link2">
